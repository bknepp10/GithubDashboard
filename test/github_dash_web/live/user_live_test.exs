defmodule GithubDashWeb.UserLiveTest do
  use GithubDashWeb.ConnCase

  import Phoenix.LiveViewTest
  import GithubDash.GithubUsersFixtures

  @create_attrs %{name: "some name", repos: "some repos", url: "some url"}
  @update_attrs %{name: "some updated name", repos: "some updated repos", url: "some updated url"}
